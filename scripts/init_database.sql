...
====================================================
Script Purpose: 
  This script will create a new database named 'DataWarehouse' after checking first if it already exists, to avoid errors.
...
WARNING:
  ...
  All data in the database will be permamentnly deleted. 
